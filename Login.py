...
label_head = Label(root, text="Payroll Portal",width=15,font=("Tahoma", 40,"bold"),fg ="#E68364", background='black',justify="center")
...
image = Image.open("payroll1.webp")
